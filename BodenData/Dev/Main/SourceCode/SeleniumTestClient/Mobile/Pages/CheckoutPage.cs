...
namespace UAT.Mobile.Automation.Mobile.Pages
{
    public class CheckoutPage : BasePage
    {
        ...
        public IWebElement FinishedContact => _webDriverManager.Wait.Until(
            ExpectedConditions.ElementToBeClickable(By.Id("finishedContact")));
            ...
            get
            {
                ...
                while (staleElement)
                {
                    try
                    {
                        ...
                        webElement = _webDriverManager.Wait.Until(ExpectedConditions.ElementExists(By.XPath(".//*[@id='coShoppingBag']/div/div[4]/p[2]/span")));
        ...
        public IWebElement TotalPrice
        {
            get
            {
                ...
                while (staleElement)
                {
                    ...
                    {
                        //TODO: assign id to get handle on shipping web element..
                        webElement = _webDriverManager.Wait.Until(ExpectedConditions.ElementExists(By.XPath(".//*[@id='coShoppingBag']/div/div[4]/p[1]/span")));
