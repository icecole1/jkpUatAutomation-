...
namespace UAT.Mobile.Automation.WebDriver
{
    public class WebDriverFactory
    {
        ...
        private static Proxy ConfigureProxy()
        {
            ...
            httpClient.Blacklist(@".*photorank*", (int)HttpStatusCode.OK);
        ...
        private static void ConfigureWebDriver(Proxy proxy)
        {
            ...
            switch (Configuration.Browser)
            {
                case "chrome":
                    ...
                    //chromeOptions.AddArguments("--force-device-scale-factor1");
        ...
        private static void ConfigureWebDriverWait()
        {
            ...
            if (Configuration.Browser.Equals("browserstack"))
            {
                timespanInSeconds = new TimeSpan(0, 0, 0, Configuration.WebDriverWaitInSeconds + 20);
            }
            else
            {
                timespanInSeconds = new TimeSpan(0, 0, 0, Configuration.WebDriverWaitInSeconds);
            }
