...
namespace UAT.Mobile.Automation.Helpers
{
    ...
    {
        private static string _emailCreditCard = string.Empty;
        private static string _emailOpenInvoicePos = string.Empty;
        private static string _emailOpenInvoiceNeg = string.Empty;

        public static string EmailCreditCard
        {
            get
            {
                if (_emailCreditCard == string.Empty)
                {
                    _emailCreditCard = DataHelper.GetComputerNameEmailAddress("CC");
                }

                return _emailCreditCard;
            }
        }
        ...
        public static string EmailOpenInvoiceNeg
        {
            get
            {
                if (_emailOpenInvoiceNeg == string.Empty)
                {
                    _emailOpenInvoiceNeg = DataHelper.GetComputerNameEmailAddress("OIN");
                }

                return _emailOpenInvoiceNeg;
            }
        }

        public static string EmailOpenInvoicePos
        {
            get
            {
                if (_emailOpenInvoicePos == string.Empty)
                {
                    _emailOpenInvoicePos = DataHelper.GetComputerNameEmailAddress("OIP");
                }

                return _emailOpenInvoicePos;
            }
        }
        ...
        public static string EmailStaff
        {
            get
            {
                switch (Configuration.Market)
                {
                    case Enums.Market.UK:
                        return UKCustomer.EmailStaff;
                    case Enums.Market.US:
                        return USCustomer.EmailStaff;
                    default:
                        return null;
                }
            }
        ...
        public static string PasswordStaff
        {
            get
            {
                ...
                {
                    case Enums.Market.UK:
                        return UKCustomer.PasswordStaff;
                    case Enums.Market.US:
                        return USCustomer.PasswordStaff;
                    default:
                        return null;
                }
            }
