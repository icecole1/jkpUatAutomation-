...
namespace UAT.Mobile.Automation.Mobile.Pages.Panels
{
    public class DeliveryAddress
    {
        ...
        public DeliveryAddress(WebDriverManager webDriverManager)
        {
        ...
        // TODO: add unique id for billing addresslookup.
        public IWebElement LookUpAddress => _webDriverManager.Wait.Until(ExpectedConditions.ElementToBeClickable(By.XPath(".//*[@id='coAddShippingAddress']/div[3]/div/button")));
        ...
        public IWebElement AddNewAddress
        {
            get
            {
                var webElement = _webDriverManager.Wait.Until(ExpectedConditions.ElementExists(By.Id("coActionNewDeliveryAddress")));
        ...
        public SelectElement Country => new SelectElement(_webDriverManager.Wait.Until(
            ExpectedConditions.ElementToBeClickable(By.Id("DeliveryAddress_CountryCode"))));

        public IWebElement AddressLine1 => _webDriverManager.Wait.Until(
            ExpectedConditions.ElementToBeClickable(By.Id("DeliveryAddress_AddressLine1")));

        public IWebElement AddressLine2 => _webDriverManager.Wait.Until(
            ExpectedConditions.ElementToBeClickable(By.Id("DeliveryAddress_AddressLine2")));

        public IWebElement AddressLine3 => _webDriverManager.Wait.Until(
            ExpectedConditions.ElementToBeClickable(By.Id("DeliveryAddress_AddressLine3")));

        public IWebElement AddressLine4 => _webDriverManager.Wait.Until(
            ExpectedConditions.ElementToBeClickable(By.Id("DeliveryAddress_AddressLine4")));

        public IWebElement AddressLine5 => _webDriverManager.Wait.Until(
            ExpectedConditions.ElementToBeClickable(By.Id("DeliveryAddress_AddressLine5")));
        ...
        public IWebElement State => _webDriverManager.Wait.Until(
            ExpectedConditions.ElementToBeClickable(By.Id("DeliveryAddress_AddressLine6")));

        public IWebElement Postcode => _webDriverManager.Wait.Until(
            ExpectedConditions.ElementToBeClickable(By.Id("DeliveryAddress_Postcode")));

        public IWebElement ZipCode => _webDriverManager.Wait.Until(
            ExpectedConditions.ElementToBeClickable(By.Id("DeliveryAddress_Postcode")));

        public IWebElement LookupPostcode => _webDriverManager.Wait.Until(
            ExpectedConditions.ElementToBeClickable(By.Id("DeliveryAddress_AddressLookup_PostCode")));
        ...
        public void Populate()
        {
            switch (Configuration.Market)
            {
                case Enums.Market.UK:
                    ...
                    break;
                case Enums.Market.US:
                    AddressLine3.SendKeys(USCustomer.AddressLine3);
                    AddressLine4.SendKeys(USCustomer.AddressLine4);
                    City.SendKeys(USCustomer.City);
                    State.SendKeys(USCustomer.State);
                    ZipCode.SendKeys(USCustomer.ZipCode);
                    break;
                case Enums.Market.AU:
                    AddressLine1.SendKeys(CustomerData.AddressLine1);
