...
namespace UAT.Mobile.Automation.Mobile.Pages.Panels
{
    public class BillingAddress
    {
        ...
        public IWebElement LookUpAddress => _webDriverManager.Wait.Until(ExpectedConditions.ElementToBeClickable(By.XPath("//*[@id='coAddBillingAddress']/div[3]/div/button")));
