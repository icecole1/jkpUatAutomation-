...
@heartbeat @checkout @delivery @uk @deliveryoption
...
When I click on a <deliveryOption> delivery 
And I place an order
Then The confirmation page displays <deliveryOption> in the delivery selection
Examples: 
| deliveryOption   |
| Standard         |
| Royal Mail       |
...
#Not to run on PreProd due to Environment Issues
@heartbeat @checkout @delivery @us @deliveryoption
...
#Not to run on PreProd due to Environment Issues
@heartbeat @checkout @delivery @de @deliveryoption
...
#Not to run on PreProd due to Environment Issues
@heartbeat @checkout @delivery @fr @deliveryoption
...
#Not to run on PreProd due to Environment Issues
@heartbeat @checkout @delivery @au @deliveryoption
