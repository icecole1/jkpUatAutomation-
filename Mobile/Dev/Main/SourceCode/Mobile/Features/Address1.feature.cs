...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("As a customer I want to lookup an address for UK Market")]
        [NUnit.Framework.CategoryAttribute("address")]
        [NUnit.Framework.CategoryAttribute("uk")]
        public virtual void AsACustomerIWantToLookupAnAddressForUKMarket()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("As a customer I want to lookup an address for UK Market", new string[] {
                        "address",
                        "uk"});
#line 14
this.ScenarioSetup(scenarioInfo);
