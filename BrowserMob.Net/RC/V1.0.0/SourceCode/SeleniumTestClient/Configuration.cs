...
namespace UAT.Mobile.Automation
{
    public static class Configuration
    {
        ...
        /// <summary>
        /// Used to specify the proxy url for pre production environment.
        /// </summary>
        ...
        /// </summary>
        public static bool UseGlobalE => bool.Parse(ConfigurationManager.AppSettings["UseGlobalE"]);

        /// <summary>
        /// Used to specify the proxy url for globale environment.
        /// </summary>
        public static string GlobalEProxyUrl => ConfigurationManager.AppSettings["GlobalEProxyUrl"];

        /// <summary>
        /// Used for global e proxy username credential.
        /// </summary>
        public static string GlobalEProxyUsername => ConfigurationManager.AppSettings["GlobalEProxyUsername"];

        /// <summary>
        /// Used for global e proxy password credential.
        /// </summary>
        public static string GlobalEProxyPassword => ConfigurationManager.AppSettings["GlobalEProxyPassword"];
    }
}
